...
var Fireworks = function( inWidth, inHeight ){
	...
	self.init = function(){	
		...
		//console.log("===> canvasContainer :"+self.canvasContainer);
		...
		self.canvas.width = self.cw = inWidth;
		self.canvas.height = self.ch = inHeight;	
		...
		self.fworkSpeed = 2;
		self.fworkAccel = 4;
		self.hueVariance = 100;		// 색상배합
		self.flickerDensity = 20;
		self.showShockwave = false;
		self.showTarget = true;
		self.clearAlpha = 50;		// 잔상시간
		self.lineWidth = 1.2;
	...
	self.createFireworks = function(startX, startY, targetX, targetY){		
		//console.log("===> createFireworks() :"+targetX);
